...
#'
#' * `ped`: A [pedtools::ped] object describing a pedigree with 19 individuals, including genotypes for 14 members at 248 markers on Chromosome 1.
#'
#' * `aff`: A vector indicating the affected pedigree members.
#'
#' * `map`: A data frame with 3 columns (`chrom`, `marker`, `cm`) describing the centiMorgan positions of the markers.
#'
#' @examples
#'
#' data(dominant1)
